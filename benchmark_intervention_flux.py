...
def parse_args():
    ...
    parser.add_argument("--preserve-intervention-steps", type=int, default=1,
                        help="Intervention steps for preserve/non-edit region; negative values mean effective_steps + value")
    parser.add_argument("--edit-intervention-steps", type=int, default=1,
...
def run_benchmark(args, analyzer):
    ...
    Output structure matches benchmark_outputs:
        {output_path}/{total_steps}_pres{preserve_steps}_edit{edit_steps}_{threshold}/
            {editing_type_dir}/
                {image_id}/
                    original.jpg
